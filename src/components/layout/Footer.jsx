...
const Footer = () => {
  ...
  return (
    <footer className="bg-github-bg-secondary border-t border-github-border mt-8">
      <div className="container mx-auto px-4 py-6">
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <div className="flex items-center space-x-6 text-sm text-github-text-secondary">
            <span>© {currentYear} {APP_CONFIG.name}</span>
            <span>•</span>
            <a 
              href={APP_CONFIG.repository} 
              className="hover:text-github-text transition-colors flex items-center space-x-1"
              target="_blank"
          ...
          <div className="flex items-center space-x-4">
            <span className="text-sm text-github-text-secondary">Built with</span>
            <div className="flex items-center space-x-2">
              <svg className="w-4 h-4 text-github-blue" fill="currentColor" viewBox="0 0 24 24">
              ...
              <span className="text-xs text-github-text-secondary">React</span>
              <span className="text-github-text-muted">+</span>
              <img src={puterLogo} alt="Puter" className="w-4 h-4" />
              <span className="text-xs text-github-text-secondary">Puter-JS</span>
            </div>
          </div>
        </div>
      </div>
